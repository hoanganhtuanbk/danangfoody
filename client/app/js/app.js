    ...
    .config(['$translateProvider', function ($translateProvider) {
      ...
      var translationsKR = {
        ...
        INFO: {
          ...
          CONTENT2: '베트남 음식들이 고대 아시아의 철학과 점성술을 대표하는 다섯 가지 맛을 나타낸다는 사실을 알고계신가요? 향신료를 넣는 것은 금속을, 신맛은 나무를, 쓴맛은 불을, 짠맛은 물을, 단 맛은 지구를 나타낸답니다.',
          CONTENT3: '만약 여러분들께서 여행사 사이트에 나와 있는 흔한 ‘여행객 음식’을 맛보는 대신에 실제 현지 음식을 경험해보고 싶으시다면, 또한, 베트남의 역사, 문화, 그리고 사람들에 대한 보다 자세한 경험을 하고 싶으시다면, <strong>FOODY STORY TOUR</strong> 가 바로 여러분을 위한 투어입니다. 투어의 소요 시간은 3시간이며 베트남 현지 식품 전문가 여러분들께 7가지의 음식을 소개 시켜드리고 그에 따른 이야기를 들려드릴 것입니다.',
          PS: '이야기의 내용은 이렇습니다...'
        },
        TOUR: {
          WCONTENT: '저희 <strong>FOODY STORY TOUR</strong> 는 어떠한 식재료나 조리법에도 거부를 표하시지 않으시며 칼로리를 소모를 위해 걸어 다니시는 것을 선호하시는 분들께 추천합니다.',

          CCONTENT: '<strong>FOODY STORY TOUR</strong>와 베트남 문화, 사진촬영까지 동시에 즐기는 건 어떠세요? CYCLO는 여러분을 베트남이 프랑스의 식민지였던 때로 이동 시켜줄 삼륜 모터 사이클입니다. 여러분은 베트남 사람들이 식민지배 시절에 어떻게 생활하였는지 그대로 느낄 수 있습니다. (호텔 왕복 교통편은 포함되지 않습니다)',

          TCONTENT: '그룹이나 친구가 있으세요? 호텔이 도심에서 멀리 떨어져 있나요? <strong>FOODY STORY TOUR</strong> 는 여러분들의 편의를 위해 택시로 출발지에서 도착지까지 태워드리는 서비스를 제공합니다.',
          BTN: '지금 예약하세요',
          WPRICE: '$30',
          CPRICE: '$40',
          TPRICE: '$45',
        ...
        DISHES: {
          DES1: '비슷비슷하지만 다른',
          DES2: '동양과 서양사이의 로맨스',
          DES3: '맛있는 음식을 해주는 것이 남자의 마음을 사로잡는 법이다.',
          DES4: '참족의 놀라운 이야기.',
          DES5: '모든 남자는 왕이 될 수 있고, 모든 여자는 여왕이 될 수 있다.',
          DES6: '행복은 자급자족에서 오는 것',
          DES7: '좋은 일은 기다릴 줄 아는 사람에게 생기는 것'
        },
        MODAL: {
